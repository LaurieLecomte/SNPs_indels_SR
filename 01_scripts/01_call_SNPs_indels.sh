...
# parallel -a 02_infos/chr.txt -k -j 10 srun -c 4 --mem=10G -p ibis_medium --time=7-00:00:00 -J 01_call_SNPs_indels_{} -o log/01_call_SNPs_indels_{}_%j.log 01_scripts/01_call_SNPs_indels.sh {} &
